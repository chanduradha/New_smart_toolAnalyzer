...
useEffect(() => {
  ...
  const traces = [
    ...
    },
    {
      ...
      yaxis: 'y',
      mode: "lines+markers", // Share the y-axis with bending moment Y
      stroke: {
        width: 0.5, // Set your desired stroke width
      },
    },
  ...
  if (filteredSeries.combinedSquaredBendingMoments) {
    ...
    const traceCombinedSquaredBendingMoments = {
      ...
      yaxis: 'y', // Share the y-axis with bending moment Y
      stroke: {
        width: 0.5, // Set your desired stroke width
      },
    };
  ...
  const layout = {
    ...
    yaxis3: {
      ...
      overlaying: "y",
      position: 0.03,
      side: "left", // Adjust this value as needed
...
/> 
   ...
   <div className="border border-black p-4 rounded-lg shadow-lg bg-gray-300" style={{ border: '2px solid #000', display: 'inline-block', position: 'relative', left:'50%',bottom:'1200px', width:'1150px', height:'400px'}}>  
